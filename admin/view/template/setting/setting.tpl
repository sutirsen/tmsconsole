						...
						<!-- BEGIN SAMPLE FORM PORTLET-->   
		                  <div class="portlet box blue">
		                     ...
		                     <div class="portlet-body form">
		                     	<!-- Not used Field from old system are listed here, Please check errors in the following divs-->
			                     	<input type="hidden" data-fieldname="<?php echo $entry_name; ?>" name="config_name" value="<?php echo $config_name; ?>"/>
			                     	<?php if ($error_name) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_name; ?></div><?php } ?>
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_owner; ?>" name="config_owner" value="<?php echo $config_owner; ?>" />
			                     	<?php if ($error_owner) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_owner; ?></div><?php } ?>
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_address; ?>" name="config_address" value="<?php echo $config_address; ?>"/>
			                     	<?php if ($error_address) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_address; ?></div><?php } ?>
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_email; ?>" name="config_email" value="<?php echo $config_email; ?>"/>
			                     	<?php if ($error_email) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_email; ?></div><?php } ?>
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_telephone; ?>" name="config_telephone" value="<?php echo $config_telephone; ?>"/>
			                     	<?php if ($error_telephone) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_telephone; ?></div><?php } ?>
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_fax; ?>" name="config_fax" value="<?php echo $config_fax; ?>"/>
			                     	
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_title; ?>" name="config_title" value="<?php echo $config_title; ?>"/>
			                     	<?php if ($error_title) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_title; ?></div><?php } ?>
			                     	
			                     	<input type="hidden" data-fieldname="<?php echo $entry_meta_description; ?>" name="config_meta_description" value="<?php echo $config_meta_description; ?>"/>
			    					
			    					<select data-fieldname="<?php echo $entry_template; ?>" name="config_template" onchange="$('#template').load('index.php?route=setting/setting/template&token=<?php echo $token; ?>&template=' + encodeURIComponent(this.value));" style="display:none;">
            						...
            						<select data-fieldname="<?php echo $entry_layout; ?>" name="config_layout_id" style="display: none;">
					                ...
					                <select data-fieldname="<?php echo $entry_country; ?>" style="display: none;" name="config_country_id">
					                ...
					                <select data-fieldname="<?php echo $entry_zone; ?>" name="config_zone_id" style="display:none;">
                					</select>
                					<select data-fieldname="<?php echo $entry_language; ?>" style="display: none;" name="config_language">
					                ...
					                <select name="config_currency" data-fieldname="<?php // echo $entry_currency; ?>" style="display: none;">
					                ...
					                <div style="display:none;">
						                ...
						                <input type="radio" style="display:none;" data-fieldname="<?php //echo $entry_currency_auto; ?>" name="config_currency_auto" value="1" checked="checked" />
						                <?php echo $text_yes; ?>
						                <input type="radio" style="display:none;" data-fieldname="<?php //echo $entry_currency_auto; ?>" name="config_currency_auto" value="0" />
						                <?php echo $text_no; ?>
						                <?php } else { ?>
						                <input type="radio" style="display:none;" data-fieldname="<?php //echo $entry_currency_auto; ?>" name="config_currency_auto" value="1" />
						                <?php echo $text_yes; ?>
						                <input type="radio" style="display:none;" data-fieldname="<?php //echo $entry_currency_auto; ?>" name="config_currency_auto" value="0" checked="checked" />
						                <?php echo $text_no; ?>
						                <?php } ?>
					                </div>
					                
					                <select name="config_length_class_id" data-fieldname="<?php //echo $entry_length_class; ?>" style="display:none;">
					                ...
					                <select name="config_weight_class_id" data-fieldname="<?php echo $entry_weight_class; ?>" style="display:none;">
					                ...
					                <input type="hidden" data-fieldname="<?php //echo $entry_catalog_limit; ?>" name="config_catalog_limit" value="<?php echo $config_catalog_limit; ?>"/>
			                     	<?php if ($error_catalog_limit) { ?><div class="error_hidden_container" style="display:none;"><?php echo $error_catalog_limit; ?></div><?php } ?>
			                     	
			                     	<!-- Maintaining Old Form Structure from this point onwards -->
					           ...
					           <!-- Not used field list end -->
					           
					           <!-- Required Fields Start -->
								<div class="control-group">
	                              <label class="control-label"><?php echo $entry_admin_language; ?></label>
	                              <div class="controls">
		                              <select name="config_admin_language" class="span6 m-wrap" id="config_admin_language">
					                    <?php foreach ($languages as $language) { ?>
	                           ...
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_admin_limit; ?>*</label>
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_admin_limit" value="<?php echo $config_admin_limit; ?>" id="config_admin_limit" size="3" />
	                                 <?php if ($error_admin_limit) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_admin_limit; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_ftp_host; ?></label>
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_ftp_host" value="<?php echo $config_ftp_host; ?>" id="config_ftp_host" />
	                                 <?php if ($error_ftp_host) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_ftp_host; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
	                           	
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_ftp_port; ?></label>
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_ftp_port" value="<?php echo $config_ftp_port; ?>" id="config_ftp_port" />
	                                 <?php if ($error_ftp_port) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_ftp_port; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
	                           
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_ftp_username; ?></label>
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_ftp_username" value="<?php echo $config_ftp_username; ?>" id="config_ftp_username" />
	                                 <?php if ($error_ftp_username) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_ftp_username; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
	                           	
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_ftp_password; ?></label>
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_ftp_password" value="<?php echo $config_ftp_password; ?>" id="config_ftp_password" />
	                                 <?php if ($error_ftp_password) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_ftp_password; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
	                           
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_ftp_root; ?></label>
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_ftp_root" value="<?php echo $config_ftp_root; ?>" id="config_ftp_root" />
	                              </div>
	                           </div>
	                           
	                           <div class="control-group">
	                              <label class="control-label"><?php echo $entry_ftp_status; ?></label>
	                              <div class="controls">
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                              	  <select name="config_mail_protocol" class="span6 m-wrap">
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_mail_parameter" value="<?php echo $config_mail_parameter; ?>" id="config_mail_parameter" />
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_smtp_host" value="<?php echo $config_smtp_host; ?>" id="config_smtp_host" />
	                              </div>
	                           </div>
	                          ...
	                          <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_smtp_username" value="<?php echo $config_smtp_username; ?>" id="config_smtp_username" />
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_smtp_password" value="<?php echo $config_smtp_password; ?>" id="config_smtp_password" />
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_smtp_port" value="<?php echo $config_smtp_port; ?>" id="config_smtp_port" />
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_smtp_timeout" value="<?php echo $config_smtp_timeout; ?>" id="config_smtp_timeout" />
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_encryption" value="<?php echo $config_encryption; ?>" id="config_encryption" />
	                                 <?php if ($error_encryption) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_encryption; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
	                           ...
	                           <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input type="text" class="span6 m-wrap" name="config_error_filename" value="<?php echo $config_error_filename; ?>" id="config_error_filename" />
	                                 <?php if ($error_error_filename) { ?>
	                                 <span class="help-inline" style="color:red;"><?php echo $error_error_filename; ?></span>
	              					 <?php } ?>
	                              </div>
	                           </div>
